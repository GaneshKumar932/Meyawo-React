        ...
        <div className="container text-center">
            ...
            <div className="blog-card">
                <div className="blog-card-header">
                    <img src={img1} className="blog-card-img" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page"/>
                </div>
            ...
            <div className="blog-card">
                <div className="blog-card-header">
                    <img src={img2} className="blog-card-img" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page"/>
                </div>
                <div className="blog-card-body">
